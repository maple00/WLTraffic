 ...
 * @Desc: 实名制
 */
public final class RealNameActivity extends BaseActivity implements View.OnClickListener, OnHttpListener {
    ...
    protected void initData() {
        ...
        dialog.showDialog();
        // 加载数据
        new Thread(() -> RequestPost.getItemFarmerTwoData(Contants.ITEM_ID, RealNameActivity.this)).start();
    }
    ...
    public void onHttpSucceed(HttpResponse result) {
        ...
        if ("1".equals(body.get("code"))){
            data = JsonParser.parseJSONArray(RealNameBean.class, body.get("data"));
            dismissDialog();
