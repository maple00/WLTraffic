 ...
 * @Desc: 项目中的子项目
 */
public class FarmersSalaryManagerAdapter extends BaseAdapter {

    private Context mContext;
    private List<SubIteProjectBean> mList;

    public FarmersSalaryManagerAdapter(Context mContext, List<SubIteProjectBean> mList) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ViewHolder holder;
        if (convertView == null){
            convertView = LayoutInflater.from(mContext).inflate(R.layout.item_farmers_salary_manager, parent, false);
